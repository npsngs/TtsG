 ...
 *   oo
 */
public class Tetris4 extends TetrisNode {
    public Tetris4(float unitSize, float unitMargin, RectF realFrame) {
    ...
    public void onDirectionChange(int direction) {
        ...
        switch (direction){
            case 0:
                unitMatrix.set(1, 0, 4);
                unitMatrix.set(2, 0, 4);
                unitMatrix.set(0, 1, 4);
                unitMatrix.set(1, 1, 4);
                break;
            case 1:
                unitMatrix.set(2, 1, 4);
                unitMatrix.set(2, 2, 4);
                unitMatrix.set(1, 0, 4);
                unitMatrix.set(1, 1, 4);
                break;
            case 2:
                unitMatrix.set(0, 2, 4);
                unitMatrix.set(1, 2, 4);
                unitMatrix.set(1, 1, 4);
                unitMatrix.set(2, 1, 4);
                break;
            case 3:
                unitMatrix.set(0, 0, 4);
                unitMatrix.set(0, 1, 4);
                unitMatrix.set(1, 1, 4);
                unitMatrix.set(1, 2, 4);
                break;
    ...
    public void calculateShadowY(UnitMatrix matrix) {
        ...
        do {
            switch (direction){
                case 0:
                    if(matrix.get(ofsX+1, ofsY+1) != UnitMatrix.NULL ||
                ...
                case 2:
                    if(matrix.get(ofsX+1, ofsY+2) != UnitMatrix.NULL ||
                            matrix.get(ofsX, ofsY+2) != UnitMatrix.NULL ||
